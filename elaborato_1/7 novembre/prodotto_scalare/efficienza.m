...
figure(2)
plot(p,c(:,1),'-*',p,c(:,2),'-o',p,c(:,3),'-+',p,c(:,4),'-s',p,c(:,5),'-d',p,ones(1,4),'--','LineWidth',2)
title('Analisi efficienza')
legend('N=10^4','N=10^5','N=10^6','N=10^7','N=10^8','Efficienza ideale','Location','southwest')
xlim([p(1) p(4)])
ylim([0 1.05])
