...
p=[2,4,8];
tabella_speedup_rmaggc = readtable('test_valutazione_elab2_OpenMp.xlsx', 'Range', 'B4:E7','ReadRowName', true);
tabella_speedup_requc = readtable('test_valutazione_elab2_OpenMp.xlsx', 'Range', 'B9:E12','ReadRowName', true);
tabella_speedup_rminc = readtable('test_valutazione_elab2_OpenMp.xlsx', 'Range', 'B14:E17','ReadRowName', true);
