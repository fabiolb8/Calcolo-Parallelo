...
p=[2,4,8,16];
tabella_tempi_rmaggc = readtable('test_valutazione_elab2_prodotto_righe.xlsx', 'Range', 'B46:E50','ReadRowName', true);
tabella_tempi_requc = readtable('test_valutazione_elab2_prodotto_righe.xlsx', 'Range', 'B52:E56','ReadRowName', true);
tabella_tempi_rminc = readtable('test_valutazione_elab2_prodotto_righe.xlsx', 'Range', 'B58:E62','ReadRowName', true);
