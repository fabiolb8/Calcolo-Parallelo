...
p=[4,9,16];
tabella_speedup_rmaggc = readtable('test_valutazione_elab2_prodotto_blocchi.xlsx', 'Range', 'B4:E7','ReadRowName', true);
tabella_speedup_requc = readtable('test_valutazione_elab2_prodotto_blocchi.xlsx', 'Range', 'B9:E12','ReadRowName', true);
tabella_speedup_rminc = readtable('test_valutazione_elab2_prodotto_blocchi.xlsx', 'Range', 'B14:E17','ReadRowName', true);
...
legend('M=5000','M=50000','M=300000','Speedup ideale','Location','SouthEast')
xlim([p(1) p(3)])
...
legend('N=5000','N=50000','N=300000','Speedup ideale','Location','SouthEast')
xlim([p(1) p(3)])
xlabel('Numero di processori');
ylabel('Speedup S(p)');
