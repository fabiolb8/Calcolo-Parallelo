...
p=[4,9,16];
tabella_efficienza_rmaggc = readtable('test_valutazione_elab2_prodotto_blocchi.xlsx', 'Range', 'B22:E25','ReadRowName', true);
tabella_efficienza_requc = readtable('test_valutazione_elab2_prodotto_blocchi.xlsx', 'Range', 'B27:E30','ReadRowName', true);
tabella_efficienza_rminc = readtable('test_valutazione_elab2_prodotto_blocchi.xlsx', 'Range', 'B32:E35','ReadRowName', true);
...
legend('M=5000','M=50000','M=300000','Efficienza ideale','Location','SouthEast')
xlim([p(1) p(3)])
ylim([0 1.05])
...
legend('N=5000','N=50000','N=300000','Efficienza ideale','Location','SouthWest')
xlim([p(1) p(3)])
ylim([0 1.05])
xlabel('Numero di processori');
ylabel('Efficienza E(p)');
