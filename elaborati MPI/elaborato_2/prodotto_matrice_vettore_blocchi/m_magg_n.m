...
tabella_efficienza_righe = readtable('test_valutazione_elab2_prodotto_righe.xlsx', 'Range', 'C26:E27');
tabella_efficienza_colonne = readtable('test_valutazione_elab2_prodotto_colonne.xlsx', 'Range', 'C26:E27');
tabella_efficienza_blocchi = readtable('test_valutazione_elab2_prodotto_blocchi.xlsx', 'Range', 'C22:E23');
...
ylim([0 1.1]);
title('Analisi comparata con griglia 2x2 con M > N=1000')
